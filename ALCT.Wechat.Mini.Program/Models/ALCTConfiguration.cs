namespace ALCT.Wechat.Mini.Program.Models
{
    public class ALCTConfiguration
    {
        ...
        public string UploadShipmentImageUrl {get; set;} = "api/v1/openapi/shipments/images";
        public string DeleteShipmentImageUrl {get; set;} = "api/v1/openapi/shipments/images?shipmentCode={0}&fileName={1}&imageType={2}";
        public string GetShipmentImagesUrl {get; set;} = "api/v1/openapi/shipments/images-data?shipmentCode={0}&imageType={1}";
